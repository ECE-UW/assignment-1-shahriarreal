...
class ProgramLoop(cmd.Cmd):
    ...
    def parseline(self, line):
        """
        The line is parsed into a command name and a string containing the arguments.
        Returns a tuple containing (command, args, line).
        If line can't be parsed 'command' and 'args' will be none
        """
        line = line.strip()
        if not line:
    ...
    def do_a(self, args):
        """
        For the add command it is like a help string
        """
    ...
    def do_r(self, args):
        """
        For the remove command it is like a help string
        """
    ...
    def do_c(self, args):
        """
        For the change command it is like a help string
        """
    ...
    def do_g(self, args):
        """
        For the generating graph command it is like a help string
        """
        if not args:
